               ...
               clint.animateOnce(time);
                if (clint.currentFrame == 11 && currentFrame != 11)
                {
                    ...
                    if (geodeSpot.item != null)
                    {
                        ...
                        geodeDestructionAnimation = new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, y, 64, 64), 100f, 8, 0, new Vector2(geodeSpot.bounds.X + 392 - 32, geodeSpot.bounds.Y + 192 - 32), false, false);
                        if (geodeSpot.item != null && geodeSpot.item.ParentSheetIndex == 275)
                        {
                ...
                if (geodeDestructionAnimation != null && (geodeDestructionAnimation.id != 777.0 && geodeDestructionAnimation.currentParentTileIndex < 7 || geodeDestructionAnimation.id == 777.0 && geodeDestructionAnimation.currentParentTileIndex < 5))
                {
                    ...
                    else
                    {
                        ...
                        {
                            sparkle = new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 640, 64, 64), 100f, 8, 0, new Vector2(geodeSpot.bounds.X + 392 - 32, geodeSpot.bounds.Y + 192 + yPositionOfGem - 32), false, false);
        ...
        public override void draw(SpriteBatch b)
        {
            ...
            if (geodeSpot.item != null)
            {
                if (geodeDestructionAnimation == null)
                    geodeSpot.item.drawInMenu(b, new Vector2(geodeSpot.bounds.X + 360 + (geodeSpot.item.ParentSheetIndex == 275 ? -8 : 0), geodeSpot.bounds.Y + 160 + (geodeSpot.item.ParentSheetIndex == 275 ? 8 : 0)), 1f);
                else
